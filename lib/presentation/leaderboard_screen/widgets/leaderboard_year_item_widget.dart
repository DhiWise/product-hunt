...
class LeaderboardYearItemWidget extends StatelessWidget {
  LeaderboardYearItemWidget(this.leaderboardYearItemModelObj,
      {this.onTapRow});

  LeaderboardYearItemModel leaderboardYearItemModelObj;
      ...
      child: GestureDetector(
        ...
        child: Row(
          ...
          children: [
            Obx(
              () => CommonImageView(
                url: leaderboardYearItemModelObj.rectangleFourImg.value,
                height: getSize(
                  50.00,
                ),
                width: getSize(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        leaderboardYearItemModelObj.nimbusTxt.value,
                  ...
                  Container(
                    ...
                    child: Obx(
                      () => Text(
                        leaderboardYearItemModelObj.cloudbasedecoTxt.value,
                        maxLines: null,
                        textAlign: TextAlign.left,
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Obx(
                          () => Text(
                            leaderboardYearItemModelObj.ninetyFourTxt.value,
                            overflow: TextOverflow.ellipsis,
                            textAlign: TextAlign.left,
