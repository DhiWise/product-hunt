...
class LeaderboardTodayItemWidget extends StatelessWidget {
  LeaderboardTodayItemWidget(this.leaderboardTodayItemModelObj,
      {this.onTapRowrectanglefour});

  LeaderboardTodayItemModel leaderboardTodayItemModelObj;
      ...
      child: GestureDetector(
        ...
        child: Row(
          ...
          children: [
            Obx(
                  () => CommonImageView(
                url: leaderboardTodayItemModelObj.rectangleFourImg.value,
                height: getSize(
                  50.00,
                ),
                width: getSize(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Obx(
                          () => Text(
                            leaderboardTodayItemModelObj.nimbusTxt.value,
                  ...
                  Container(
                    ...
                    child: Obx(
                          () => Text(
                            leaderboardTodayItemModelObj.cloudbasedecoTxt.value,
                        maxLines: null,
                        textAlign: TextAlign.left,
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Obx(
                              () => Text(
                                leaderboardTodayItemModelObj.ninetyFourTxt.value,
                            overflow: TextOverflow.ellipsis,
                            textAlign: TextAlign.left,
